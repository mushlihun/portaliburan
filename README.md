...
- [\mushlihun\VacationApp](#class-takisrsvacationapp)
- [\mushlihun\Controllers\ApplicationController](#class-takisrscontrollersapplicationcontroller)
- [\mushlihun\Controllers\UserController](#class-takisrscontrollersusercontroller)
- [\mushlihun\Controllers\AuthController](#class-takisrscontrollersauthcontroller)
- [\mushlihun\Core\Router](#class-takisrscorerouter)
- [\mushlihun\Core\MySQLConnection](#class-takisrscoremysqlconnection)
- [\mushlihun\Core\Controller](#class-takisrscorecontroller)
- [\mushlihun\Core\Response](#class-takisrscoreresponse)
- [\mushlihun\Core\Model](#class-takisrscoremodel)
- [\mushlihun\Core\HttpException](#class-takisrscorehttpexception)
- [\mushlihun\Core\Authenticator](#class-takisrscoreauthenticator)
- [\mushlihun\Core\Request](#class-takisrscorerequest)
- [\mushlihun\Helpers\EmailTemplate](#class-takisrshelpersemailtemplate)
- [\mushlihun\Models\Application](#class-takisrsmodelsapplication)
- [\mushlihun\Models\User](#class-takisrsmodelsuser)

<hr />

### Class: \mushlihun\VacationApp
...
### Class: \mushlihun\Controllers\ApplicationController
...
*This class extends [\mushlihun\Core\Controller](#class-takisrscorecontroller)*

<hr />

### Class: \mushlihun\Controllers\UserController
...
### Class: \mushlihun\Controllers\AuthController
...
### Class: \mushlihun\Core\Router

> Router class

| Visibility | Function |
|:-----------|:---------|
| public | <strong>__construct(</strong><em>[\mushlihun\Core\Request](#class-takisrscorerequest)</em> <strong>$request</strong>, <em>[\mushlihun\Core\Response](#class-takisrscoreresponse)</em> <strong>$response</strong>)</strong> : <em>void</em><br /><em>Router constructor</em> |
...
### Class: \mushlihun\Core\MySQLConnection
...
| public static | <strong>getInstance()</strong> : <em>[\mushlihun\Core\MySQLConnection](#class-takisrscoremysqlconnection)</em><br /><em>Returns the instance of the MySQLConnection</em> |

<hr />

### Class: \mushlihun\Core\Controller

> Base Controller class Each controller should extend this class.

| Visibility | Function |
|:-----------|:---------|
| public | <strong>__construct(</strong><em>[\mushlihun\Core\Request](#class-takisrscorerequest)</em> <strong>$request</strong>, <em>[\mushlihun\Core\Response](#class-takisrscoreresponse)</em> <strong>$response</strong>)</strong> : <em>void</em><br /><em>Base controller constructor</em> |

<hr />

### Class: \mushlihun\Core\Response
...
| public | <strong>status(</strong><em>int</em> <strong>$code</strong>)</strong> : <em>[\mushlihun\Core\Response](#class-takisrscoreresponse)</em><br /><em>Sets the response status code</em> |

<hr />

### Class: \mushlihun\Core\Model
...
### Class: \mushlihun\Core\HttpException
...
### Class: \mushlihun\Core\Authenticator
...
| public | <strong>setParam(</strong><em>\string</em> <strong>$key</strong>, <em>string/int/\string</em> <strong>$value</strong>)</strong> : <em>[\mushlihun\Core\Request](#class-takisrscorerequest)</em><br /><em>Sets a route param</em> |
| public | <strong>setUser(</strong><em>[\mushlihun\Models\User](#class-takisrsmodelsuser)</em> <strong>$user</strong>)</strong> : <em>[\mushlihun\Core\Request](#class-takisrscorerequest)</em><br /><em>Sets the authentication user</em> |
| public | <strong>user()</strong> : <em>[\mushlihun\Models\User](#class-takisrsmodelsuser)</em><br /><em>Returns the authorized user of the request</em> |
...
### Class: \mushlihun\Helpers\EmailTemplate

> Handles email templating and sending

| Visibility | Function |
|:-----------|:---------|
| public | <strong>__construct(</strong><em>\mushlihun\Helpers\sting/\string</em> <strong>$templatePath</strong>)</strong> : <em>void</em><br /><em>Constructor</em> |
...
| public | <strong>replaceVar(</strong><em>string</em> <strong>$key</strong>, <em>string/int</em> <strong>$value</strong>)</strong> : <em>\mushlihun\Helpers\self</em><br /><em>Replaces a variable in the html content with the provided value</em> |
| public | <strong>replaceVars(</strong><em>array</em> <strong>$data</strong>)</strong> : <em>\mushlihun\Helpers\self</em><br /><em>Replaces all the variables in the html content of the email template</em> |
| public | <strong>send(</strong><em>\string</em> <strong>$email</strong>)</strong> : <em>void</em><br /><em>Sends the email</em> |

<hr />

### Class: \mushlihun\Models\Application
...
| public | <strong>user()</strong> : <em>[\mushlihun\Models\User](#class-takisrsmodelsuser)</em><br /><em>Returns application's user object</em> |

*This class extends [\mushlihun\Core\Model](#class-takisrscoremodel)*

<hr />

### Class: \mushlihun\Models\User

> User Model class

| Visibility | Function |
|:-----------|:---------|
| public | <strong>applications()</strong> : <em>[\mushlihun\Models\Application](#class-takisrsmodelsapplication)[]/null</em><br /><em>Returns an array of user's applications</em> |
